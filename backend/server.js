...
app.use(express.static("public")); // assuming bootstrap-icons.css is in the 'public' directory

// Create a connection to the MySQL database
const db = mysql.createConnection({
  host: "localhost",
  user: "root",
  password: "Charu*SQL2023",
  database: "axcen",
});

app.post("/axcentech/axcentable", (req, res) => {
  ...
  const queryString =
    "INSERT INTO axcentable (firstName, lastName, email, phoneNumber, descriptionbox) VALUES (?,?,?,?,?);";
...
function sendApplicationEmail(
  ...
  // Use recipientEmail if provided, otherwise use the user-provided email or a default email
...
app.post("/axcentech/axcentable", (req, res) => {
  ...
  db.query(queryString, values, (err, result) => {
    ...
    // Pass the recipientEmail to the sendApplicationEmail function
    sendApplicationEmail(
      req.body.firstName,
      req.body.lastName,
      req.body.email,
      req.body.phoneNumber,
      req.body.descriptionbox,
      req.body.recipientEmail || "charup3111@gmail.com"
    );
